...
Original file is located at
    https://colab.research.google.com/drive/1V3SSuUH4XhJpF6WUu0K7mF8VqPPaa5Fj
"""
...
class ModelOutputs():
	...
	def __call__(self, x):
		...
		if self.cuda:
			...
			output = model.fc(output)##这里对应use-cuda上更正一些bug,不然用use-cuda的时候会导致类型对不上,这样保证既可以在cpu上运行,gpu上运行也不会出问题.
...
def getPert_tar(image,target,window_size=43):
  ...
  #print("saving...")
  #torch.save(stdimg,"/home/c01sudu/CISPA-home/imper_patch/source/affenviz/std.pt")
  #torch.save(sens,"/home/c01sudu/CISPA-home/imper_patch/source/affenviz/sens.pt")
  #torch.save(mask,"/home/c01sudu/CISPA-home/imper_patch/source/affenviz/mask.pt")
  perturbPrior=mask/(sens+0.001)
  location,subimage = find_location(image,mask,window_size)
  return location,subimage,sens[location[0]:location[0]+window_size,location[1]:location[1]+window_size]
